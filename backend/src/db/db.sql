...
ALTER TABLE "document_questions" ADD FOREIGN KEY ("document_id") REFERENCES "documents" ("document_id") ON DELETE RESTRICT;

ALTER TABLE "document_questions" ADD FOREIGN KEY ("question_id") REFERENCES "questions" ("question_id") ON DELETE CASCADE;

ALTER TABLE "practice_histories" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id") ON DELETE RESTRICT;

ALTER TABLE "arena_histories" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id") ON DELETE RESTRICT;

ALTER TABLE "arena_histories" ADD FOREIGN KEY ("opponent") REFERENCES "users" ("user_id") ON DELETE RESTRICT;
